...
class QwenClient(BaseOpenAIClient):
    """
    QwenClient is a client class for interacting with Alibaba's Qwen (Tongyi Qianwen)
    language models via DashScope's OpenAI-compatible API.

    This class extends the BaseOpenAIClient and provides Qwen-specific implementation
    ...
    def __init__(
        ...
        """
        Initialize the QwenClient with the provided configuration, cache setting, and client.
    ...
    async def _create_structured_completion(
        ...
        Qwen's DashScope API responses.parse endpoint is not fully compatible with
        OpenAI's structured output format. We use the standard chat completions
